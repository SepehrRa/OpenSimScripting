...
ExpMuscle=["bflh_r","gasmed_r","recfem_r","semiten_r","vaslat_r","vasmed_r"];
...
%                        
%                     end
%                     for ExMu=1:length(ExpMuscle)
%                      ResultData.(filename).('EMG').(ExpMuscle(ExMu))(:,k)=EMGtable.data(Expindx,ExMu);
%                     end
%                     ResultData.(filename).('Motion')(:,k)=MTable.data(Expindx,6);
%                     ResultData.(filename).('ExForce')(:,k)=FTable.data(Expindx,10);
%                     
                end
%                 figure
%                 x=0:0.02:4;
